...
{
    /// <inheritdoc />
    public partial class InitialFinalBase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AvatarPath = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetRadius = table.Column<double>(type: "float", nullable: false),
                    TargetObjectName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Easy", "/images/levels/level1.webp", false, "Стаята на детектива", "Лупа", 5.0, 18.98, 56.060000000000002 },
